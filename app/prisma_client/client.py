...
SCHEMA_PATH = Path('/Users/yui/PersonalProjects/GITBLAME/gitVlame/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/yui/.cache/prisma-python/binaries/5.8.0/0a83d8541752d7582de2ebc1ece46519ce72a848/node_modules/prisma/query-engine-darwin-arm64', 'rhel-openssl-3.0.x': '/Users/yui/.cache/prisma-python/binaries/5.8.0/0a83d8541752d7582de2ebc1ece46519ce72a848/node_modules/prisma/query-engine-rhel-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    judgment: 'actions.JudgmentActions[models.Judgment]'
    suspect: 'actions.SuspectActions[models.Suspect]'
    blame: 'actions.BlameActions[models.Blame]'
    ...
    def __init__(
        ...
        *,
        ...
        self.judgment = actions.JudgmentActions[models.Judgment](self, models.Judgment)
        self.suspect = actions.SuspectActions[models.Suspect](self, models.Suspect)
        self.blame = actions.BlameActions[models.Blame](self, models.Blame)
...
class Batch:
    ...
    judgment: 'JudgmentBatchActions'
    suspect: 'SuspectBatchActions'
    blame: 'BlameBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.judgment = JudgmentBatchActions(self)
        self.suspect = SuspectBatchActions(self)
        self.blame = BlameBatchActions(self)
